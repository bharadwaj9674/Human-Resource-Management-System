...
// Wrong login. It can only handle if one user details is present in the file
...
public class toDoLogin {
	...
	public void login() throws IOException {
		...
		switch(a) {
		case 1:
			toDoLogin.director("/Users/bharath/Desktop/DSA_Project/directorLogin.txt");
			break;
		case 2:
			toDoLogin.manager("/Users/bharath/Desktop/DSA_Project/managerLogin.txt");
			break;
		case 3:
			toDoLogin.employee("/Users/bharath/Desktop/DSA_Project/employeeLogin.txt");
			break;
		}
        scan.close();
	}   
